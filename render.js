...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .faq .ans{padding:10px 14px;color:#334155;font-size:13px}
  ...
  function renderService(serviceKey) {
    ...
    const sectionsHtml = (svc.sections || []).map((sec) => `
      <details class="sec"${sec.open ? " open" : ""}>
        ...
        <div class="card">
          ...
          <div class="brandbar">
            <div class="brand-right">
              ${svc.icon ? `<div class="svc-badge"><img class="svc-icon" src="${esc(svc.icon)}" alt=""></div>` : ""}
